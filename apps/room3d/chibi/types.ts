...
export interface HairSettings extends BodyProportions { layers:Record<string,HairLayer>; extras:ExtraHair[]; assetModes?:Record<string,HairMode>; assets?:Record<string,string>; face?:import('./faceAppearance').FaceSettings; bodyShape?:'classic'|'blank'; wardrobeStyle?:'cute'|'boy'|'normal'|keyof typeof import('./wardrobeMotionCatalog.json'); wardrobe?:import('./approvedWardrobe').ApprovedWardrobe; wardrobeFits?:import('./garmentFit').WardrobeFits; wardrobeColors?:import('./wardrobeColors').WardrobeColors; wardrobeLayering?:boolean; }
...
export type Motion = 'idle' | 'sit' | 'wave' | 'wave-cute' | 'wave-calm' | 'sleep' | 'angry' | 'walk' | 'dance' | 'water' | 'computer' | 'stream' | 'race' | 'rhythm' | 'eat' | 'hug' | 'coffee' | 'wash' | 'cook' | 'mirror-admire' | 'mirror-outfit' | 'bath-shower' | 'bath-soak' | 'bath-laundry' | 'bath-toilet';
